...
// ANSI COLOR CODE for differentiating  between directories and files in explore tree
...
// recursively-delete-function-start
...
// recursively-delete-function-end
...
// create-start
            ...
            if (args.length == 0 || args.length > 2) {
                System.out.println("java fe create [target_directory/file] [target_directory/file_name]\ntype\tjava fe help\t for more\n");
            }
            if (args.length == 2) {
